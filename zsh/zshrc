...
# export MANPAGER="sh -c 'col -bx | bat --language=help --paging=always --style=plain'"
export MANROFFOPT="-c"
export MANPAGER="less -R"
export MANPAGER="most"
export GOG_ACCOUNT=anshulchauhan1224@gmail.com
...
# opencode
export PATH=/home/mir/.opencode/bin:$PATH

# Only set DISPLAY/XAUTHORITY when connected via SSH
...
# bun completions
[ -s "/home/mir/.bun/_bun" ] && source "/home/mir/.bun/_bun"
